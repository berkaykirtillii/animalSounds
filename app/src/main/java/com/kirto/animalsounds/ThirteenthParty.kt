...
import kotlinx.android.synthetic.main.activity_thirteenth_party.*
import java.util.*

class ThirteenthParty : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_thirteenth_party)
        ...
        textSkor13.text = "SCORE ${kaydedilenskor}"
        ...
        timer=object : CountDownTimer(22000,1000){
            override fun onTick(millisUntilFinished: Long) {
                if ((millisUntilFinished/1000)-2 >= 0){
                    textKalan13.text= "Time : ${(millisUntilFinished/1000)-2} sec"}
            }
    ...
    override fun onStart() {
        ...
        bTTs= TextToSpeech(this, TextToSpeech.OnInitListener { status ->
            ...
            { bTTs.language= Locale.ENGLISH
                bTTs.speak("cow",TextToSpeech.QUEUE_FLUSH,null)}
        })
        highscore= sharedPreferences.getInt("highskor",0)
        textHigh13.text= "High Score ${highscore}"
    }

    fun playdogforcow(view: View) {
    ...
    fun playelephantforcow(view: View) {
        bTTs.speak("Sorry, you chose the wrong animal.Press the button to start over.",TextToSpeech.QUEUE_FLUSH,null)
    ...
    fun playcow(view: View) {
        val kullaniciSkor= 13
        sharedPreferences.edit().putInt("skor",kullaniciSkor).apply()
        textSkor13.text = "SCORE ${kullaniciSkor}"
        ...
        object : CountDownTimer(2000,1000){
            ...
            override fun onFinish() {
                ...
                val intent = Intent(applicationContext,FourteenthParty::class.java)
                startActivity(intent)
                finish()
            }
    ...
    fun playpenguinforcow(view: View) {
        bTTs.speak("Sorry, you chose the wrong animal.Press the button to start over.",TextToSpeech.QUEUE_FLUSH,null)
