...
import kotlinx.android.synthetic.main.activity_eleventh_party.*
import java.util.*

class EleventhParty : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_eleventh_party)
        ...
        textSkor11.text = "SCORE ${kaydedilenskor}"
        ...
        timer=object : CountDownTimer(17000,1000){
            override fun onTick(millisUntilFinished: Long) {
                if ((millisUntilFinished/1000)-2 >= 0){
                    textKalan11.text= "Time : ${(millisUntilFinished/1000)-2} sec"}
            }
    ...
    override fun onStart() {
        ...
        textHigh11.text= "High Score ${highscore}"
    }

    fun playpenguinformonkey(view: View) {
    ...
    fun playgiraffeformonkey(view: View) {
        bTTs.speak("Sorry, you chose the wrong animal.Press the button to start over.",TextToSpeech.QUEUE_FLUSH,null)
    ...
    fun playpandaformonkey(view: View) {
        bTTs.speak("Sorry, you chose the wrong animal.Press the button to start over.",TextToSpeech.QUEUE_FLUSH,null)
    ...
    fun playsnakeformonkey(view: View) {
        bTTs.speak("Sorry, you chose the wrong animal.Press the button to start over.",TextToSpeech.QUEUE_FLUSH,null)
    ...
    fun playmonkey2(view: View) {
        ...
        object : CountDownTimer(2000,1000){
            ...
            override fun onFinish() {
                ...
                val intent = Intent(applicationContext,TwelfthParty::class.java)
                startActivity(intent)
                finish()
            }
    ...
    fun playcatformonkey(view: View) {
        bTTs.speak("Sorry, you chose the wrong animal.Press the button to start over.",TextToSpeech.QUEUE_FLUSH,null)
