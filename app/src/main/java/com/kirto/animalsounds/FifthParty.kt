...
import kotlinx.android.synthetic.main.activity_fifth_party.*
import java.util.*

class FifthParty : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fifth_party)
        ...
        textSkor5.text = "SCORE ${kaydedilenskor}"
        ...
        timer=object : CountDownTimer(14000,1000){
            override fun onTick(millisUntilFinished: Long) {
                if ((millisUntilFinished/1000)-2 >= 0){
                    textKalan5.text= "Time : ${(millisUntilFinished/1000)-2} sec"}
            }
    ...
    override fun onStart() {
        ...
        textHigh5.text= "High Score ${highscore}"
    }

    fun playpandaforelephant(view: View) {
    ...
    fun playelephant2(view: View) {
        val kullaniciSkor= 5
        sharedPreferences.edit().putInt("skor",kullaniciSkor).apply()
        textSkor5.text = "SCORE ${kullaniciSkor}"
        ...
        object : CountDownTimer(2000,1000){
            ...
            override fun onFinish() {
                ...
                val intent = Intent(applicationContext,SixthParty::class.java)
                startActivity(intent)
                finish()
            }
    ...
    fun playpenguinforelephant(view: View) {
        bTTs.speak("Sorry, you chose the wrong animal.Press the button to start over.",TextToSpeech.QUEUE_FLUSH,null)
