...
import kotlinx.android.synthetic.main.activity_seventh_party.*
import java.util.*

class SeventhParty : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_seventh_party)
        ...
        textSkor7.text = "SCORE ${kaydedilenskor}"
        ...
        timer=object : CountDownTimer(22000,1000){
            override fun onTick(millisUntilFinished: Long) {
                if ((millisUntilFinished/1000)-2 >= 0){
                    textKalan7.text= "Time : ${(millisUntilFinished/1000)-2} sec"}
            }
    ...
    override fun onStart() {
        ...
        bTTs= TextToSpeech(this, TextToSpeech.OnInitListener { status ->
            ...
            { bTTs.language= Locale.ENGLISH
                bTTs.speak("horse",TextToSpeech.QUEUE_FLUSH,null)}
        })
        highscore= sharedPreferences.getInt("highskor",0)
        textHigh7.text= "High Score ${highscore}"
    }

    fun playhorse1(view: View) {
        val kullaniciSkor= 7
        sharedPreferences.edit().putInt("skor",kullaniciSkor).apply()
        textSkor7.text = "SCORE ${kullaniciSkor}"
        ...
        object : CountDownTimer(2000,1000){
            ...
            override fun onFinish() {
                ...
                val intent = Intent(applicationContext,EighthParty::class.java)
                startActivity(intent)
                finish()
            }
    ...
    fun playsnakeforhorse(view: View) {
    ...
    fun playgiraffeforhorse(view: View) {
        bTTs.speak("Sorry, you chose the wrong animal.Press the button to start over.",TextToSpeech.QUEUE_FLUSH,null)
